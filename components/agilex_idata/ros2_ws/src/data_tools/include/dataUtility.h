...
public:
    ...
    std::vector<std::string> robotBaseStateNames;
    std::vector<std::string> robotBaseActionNames;
    ...
    std::vector<std::string> robotBaseStateTopics;
    std::vector<std::string> robotBaseActionTopics;
    ...
    std::vector<std::string> robotBaseStateConfigTopics;
    std::vector<std::string> robotBaseActionConfigTopics;
    ...
    std::vector<std::string> robotBaseStatePublishTopics;
    std::vector<std::string> robotBaseActionPublishTopics;
    ...
    std::vector<std::string> robotBaseStateConfigPublishTopics;
    std::vector<std::string> robotBaseActionConfigPublishTopics;
    ...
    std::vector<std::string> robotBaseStateParentFrames;
    std::vector<std::string> robotBaseActionParentFrames;
    ...
    std::vector<std::string> robotBaseStateDirs;
    std::vector<std::string> robotBaseActionDirs;
    ...
    std::vector<bool> robotBaseStateToSyncs;
    std::vector<bool> robotBaseActionToSyncs;
    ...
    std::vector<bool> robotBaseStateToPublishs;
    std::vector<bool> robotBaseActionToPublishs;
    ...
    std::string robotBaseStateDir;
    std::string robotBaseActionDir;
    ...
    DataUtility(std::string name, const rclcpp::NodeOptions & options, std::string datasetDirParam, int episodeIndexParam): rclcpp::Node(name, options) 
    {
        ...
        declare_parameter("dataInfo.robotBase.state.names", std::vector<std::string>());get_parameter("dataInfo.robotBase.state.names", robotBaseStateNames);
        declare_parameter("dataInfo.robotBase.action.names", std::vector<std::string>());get_parameter("dataInfo.robotBase.action.names", robotBaseActionNames);
        ...
        declare_parameter("dataInfo.robotBase.state.parentFrames", std::vector<std::string>());get_parameter("dataInfo.robotBase.state.parentFrames", robotBaseStateParentFrames);
        declare_parameter("dataInfo.robotBase.action.parentFrames", std::vector<std::string>());get_parameter("dataInfo.robotBase.action.parentFrames", robotBaseActionParentFrames);
        ...
        declare_parameter("dataInfo.robotBase.state.topics", std::vector<std::string>());get_parameter("dataInfo.robotBase.state.topics", robotBaseStateTopics);
        declare_parameter("dataInfo.robotBase.action.topics", std::vector<std::string>());get_parameter("dataInfo.robotBase.action.topics", robotBaseActionTopics);
        ...
        declare_parameter("dataInfo.robotBase.state.pubTopics", std::vector<std::string>());get_parameter("dataInfo.robotBase.state.pubTopics", robotBaseStatePublishTopics);
        declare_parameter("dataInfo.robotBase.action.pubTopics", std::vector<std::string>());get_parameter("dataInfo.robotBase.action.pubTopics", robotBaseActionPublishTopics);
        ...
        robotBaseStatePublishTopics = robotBaseStatePublishTopics.size() == 0 ? robotBaseStateTopics :robotBaseStatePublishTopics;
        robotBaseActionPublishTopics = robotBaseActionPublishTopics.size() == 0 ? robotBaseActionTopics :robotBaseActionPublishTopics;
        ...
        declare_parameter("dataInfo.robotBase.state.configTopics", std::vector<std::string>());get_parameter("dataInfo.robotBase.state.configTopics", robotBaseStateConfigTopics);
        declare_parameter("dataInfo.robotBase.action.configTopics", std::vector<std::string>());get_parameter("dataInfo.robotBase.action.configTopics", robotBaseActionConfigTopics);
        ...
        declare_parameter("dataInfo.robotBase.state.pubConfigTopics", std::vector<std::string>());get_parameter("dataInfo.robotBase.state.pubConfigTopics", robotBaseStateConfigPublishTopics);
        declare_parameter("dataInfo.robotBase.action.pubConfigTopics", std::vector<std::string>());get_parameter("dataInfo.robotBase.action.pubConfigTopics", robotBaseActionConfigPublishTopics);
        ...
        robotBaseStateConfigPublishTopics = robotBaseStateConfigPublishTopics.size() == 0 ? robotBaseStateConfigTopics :robotBaseStateConfigPublishTopics;
        robotBaseActionConfigPublishTopics = robotBaseActionConfigPublishTopics.size() == 0 ? robotBaseActionConfigTopics :robotBaseActionConfigPublishTopics;
        ...
        declare_parameter("dataInfo.robotBase.state.toSyncs", std::vector<bool>());get_parameter("dataInfo.robotBase.state.toSyncs", robotBaseStateToSyncs);
        declare_parameter("dataInfo.robotBase.action.toSyncs", std::vector<bool>());get_parameter("dataInfo.robotBase.action.toSyncs", robotBaseActionToSyncs);
        ...
        robotBaseStateToSyncs = robotBaseStateToSyncs.size() == 0 ? std::vector<bool>(robotBaseStateTopics.size(), true) : robotBaseStateToSyncs;
        robotBaseActionToSyncs = robotBaseActionToSyncs.size() == 0 ? std::vector<bool>(robotBaseActionTopics.size(), true) : robotBaseActionToSyncs;
        ...
        declare_parameter("dataInfo.robotBase.state.toPublishs", std::vector<bool>());get_parameter("dataInfo.robotBase.state.toPublishs", robotBaseStateToPublishs);
        declare_parameter("dataInfo.robotBase.action.toPublishs", std::vector<bool>());get_parameter("dataInfo.robotBase.action.toPublishs", robotBaseActionToPublishs);
        ...
        robotBaseStateToPublishs = robotBaseStateToPublishs.size() == 0 ? std::vector<bool>(robotBaseStateTopics.size(), true) : robotBaseStateToPublishs;
        robotBaseActionToPublishs = robotBaseActionToPublishs.size() == 0 ? std::vector<bool>(robotBaseActionTopics.size(), true) : robotBaseActionToPublishs;
        ...
        robotBaseStateDir = robotBaseDir + "/state";
        robotBaseActionDir = robotBaseDir + "/action";
        ...
        for(int i = 0; i < robotBaseStateNames.size(); i++){
            std::string dir = robotBaseStateDir + "/" + robotBaseStateNames.at(i);
            robotBaseStateDirs.push_back(dir);
        }
        for(int i = 0; i < robotBaseActionNames.size(); i++){
            std::string dir = robotBaseActionDir + "/" + robotBaseActionNames.at(i);
            robotBaseActionDirs.push_back(dir);
        }
