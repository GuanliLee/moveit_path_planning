#!/usr/bin/env python3
# -*-coding:utf8-*-
# This node reads a single robotic arm and publishes its joint state,
# including gripper feedback when the gripper is present.
import threading
...
class PiperRosNode(Node):
    """ROS 2 node for the robotic arm."""
    ...
    def __init__(self) -> None:
        ...
        self.gripper_exist = (
            self.get_parameter('gripper_exist').get_parameter_value().bool_value
        )
    ...
    def PublishArmJointAndGripper(self):
        ...
        # Raw joint positions are degrees multiplied by 1000. Convert them to
        # radians with the existing scale factor.
        joint_1: float = (
        ...
        if self.gripper_exist:
            ...
            self.joint_states_feedback.name = [
                'joint1',
                'joint2',
                'joint3',
                'joint4',
            ...
            self.joint_states_feedback.velocity = [vel_1, vel_2, vel_3, vel_4, vel_5, vel_6, 0.0]
